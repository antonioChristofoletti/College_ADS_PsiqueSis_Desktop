 ...
 * informações de uma JTable relacionada as atividades dos pacientes
 *
 * @author Antonio Lucas Christofoletti
 */
public class PacienteAtividadeTableModel extends AbstractTableModel {
     ...
     */
    private String[] colunas = {"ID", "Nome", "Descrição", "Data", "Status"};

    /**
     * Construtor da classe
     */
    public PacienteAtividadeTableModel() {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        switch (columnIndex) {
            ...
            case 3:
                return Uteis.converteData("dd/MM/yyyy", listaAtividades.get(rowIndex).getDataAtividade());
            case 4:
    ...
    public void setValueAt(int rowIndex, String nomeColuna, Object value) {
        switch (nomeColuna) {
            ...
            case "Data": {
                listaAtividades.get(rowIndex).setDataAtividade((Date) value);
                break;
            }
            case "Status": {
    ...
    public void UpdateObject(Atividade a1) {
        ...
        for (Atividade a2 : listaAtividades) {
            if (a1.getId() == a2.getId() && a1.getDataAtividade() == a2.getDataAtividade()) {
    ...
    public void configurarTableModel(JTable tbl) {         //cada Caracter tem 7,3125 de width.
        ...
        tbl.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable table,
                ...
                String status = ((PacienteAtividadeTableModel) table.getModel()).getValueAt(row, "Status").toString();
    ...
    /**
     * Método responsável por ordenar os objetos contidos no JTable
     *
     * @param dataCrescente parâmetro de ordenação
     * @param dataDecrescente parâmetro de ordenação
     * @param ordemAlfabetica parâmetro de ordenação
     */
    public void ordernar(Boolean dataCrescente, Boolean dataDecrescente, Boolean ordemAlfabetica) {
        if (dataCrescente) {
            Collections.sort(listaAtividades, new Comparator() {
                public int compare(Object o1, Object o2) {
                    Atividade a1 = (Atividade) o1;
                    Atividade a2 = (Atividade) o2;

                    if (a1.getDataAtividade().getTime() > a2.getDataAtividade().getTime()) {
                        return 1;
                    }
                    return -1;
                }
     ...
     * @throws java.lang.Exception disparado caso a atividade já exista
     */
    ...
    /**
     * Método responsável por verificar se uma atividade já exista
     * @param a1 atividade que será validada
     * @return retorna true ou false
     */
    public boolean atividadeExiste(Atividade a1) {
        for (Atividade a2 : listaAtividades) {
            if (a1.getId() == a2.getId() && Uteis.converteData("dd/MM/yyyy", a1.getDataAtividade()).equals(Uteis.converteData("dd/MM/yyyy", a2.getDataAtividade()))) {
                return true;
            }
        }
        return false;
