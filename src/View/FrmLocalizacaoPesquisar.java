...
/**
 * JFrame relacionada a localização pesquisar
 *
 * @author Marcos Kenji Uekawa
 */
public class FrmLocalizacaoPesquisar extends javax.swing.JFrame {
     ...
     * Sington
     */
    private static FrmLocalizacaoPesquisar frmLocalizacaoPesquisar;

    /**
     * Objeto que armazena o objeto da classe que implementa a interface
     * 'IPesquisarLocalizacao' e que chamou essa tela
     */
    private IPesquisarLocalizacao iPesquisarLocalizacao;

    /**
     * Construtor da classe
     */
    private FrmLocalizacaoPesquisar() {
        initComponents();
        configuraTela();
     ...
     *
     * @param iPesquisarLocalizacao objeto da classe que implementa a interface
     * 'IPesquisarLocalizacao' e que chamou essa tela
     * @return retorna uma instância da própria classe
     */
    public static FrmLocalizacaoPesquisar getInstance(IPesquisarLocalizacao iPesquisarLocalizacao) {
        if (frmLocalizacaoPesquisar == null) {
            frmLocalizacaoPesquisar = new FrmLocalizacaoPesquisar();
        }
        
        frmLocalizacaoPesquisar.iPesquisarLocalizacao = iPesquisarLocalizacao;
        frmLocalizacaoPesquisar.localizacaoTableModel.removeAll();
        
        frmLocalizacaoPesquisar.setSize(frmLocalizacaoPesquisar.getPreferredSize());
        frmLocalizacaoPesquisar.setLocationRelativeTo(null);
        frmLocalizacaoPesquisar.limparTela();
        return frmLocalizacaoPesquisar;
    }
    ...
    public void configuraTela() {
        ...
        tblLocalizacoa.setModel(localizacaoTableModel);
        localizacaoTableModel.configurarTableModel(tblLocalizacoa);
    ...
    public void atualizarTabela() {
        try {
            ...
            if (localizacaoTableModel.getRowCount() == 0) {
                JOptionPane.showMessageDialog(null, "Nenhuma localização encontrado", "Aviso", JOptionPane.INFORMATION_MESSAGE);
            }
    ...
    private void initComponents() {
        ...
        tblLocalizacoa = new javax.swing.JTable();
        ...
        setTitle("PsiqueSis - Localização - Pesquisar");
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Localização", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 0, 18))); // NOI18N
        jPanel3.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N

        tblLocalizacoa.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        tblLocalizacoa.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tblLocalizacoa.setToolTipText("Duplo Clique para Selecionar uma Localização");
        tblLocalizacoa.addHierarchyBoundsListener(new java.awt.event.HierarchyBoundsListener() {
            public void ancestorMoved(java.awt.event.HierarchyEvent evt) {
            }
            public void ancestorResized(java.awt.event.HierarchyEvent evt) {
                tblLocalizacoaAncestorResized(evt);
            }
        });
        tblLocalizacoa.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tblLocalizacoaMouseClicked(evt);
            }
        });
        tblLocalizacoa.addComponentListener(new java.awt.event.ComponentAdapter() {
            public void componentResized(java.awt.event.ComponentEvent evt) {
                tblLocalizacoaComponentResized(evt);
            }
        });
        jScrollPane3.setViewportView(tblLocalizacoa);
    ...
    private void tblLocalizacoaAncestorResized(java.awt.event.HierarchyEvent evt) {//GEN-FIRST:event_tblLocalizacoaAncestorResized

    }//GEN-LAST:event_tblLocalizacoaAncestorResized

    private void tblLocalizacoaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblLocalizacoaMouseClicked
        if (evt.getClickCount() == 2 && !evt.isConsumed()) {
            evt.consume();
            if (tblLocalizacoa.getSelectedRow() == -1) {
                return;
            }
            
            iPesquisarLocalizacao.preencheCampos(localizacaoTableModel.getLocalizacao(tblLocalizacoa.getSelectedRow()));
            this.dispose();
        }
    }//GEN-LAST:event_tblLocalizacoaMouseClicked

    private void tblLocalizacoaComponentResized(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_tblLocalizacoaComponentResized

    }//GEN-LAST:event_tblLocalizacoaComponentResized
    ...
    private javax.swing.JTable tblLocalizacoa;
