 ...
 */
public class FrmAtividadeLista extends javax.swing.JFrame {
     ...
     * Sington
     */
    private static FrmAtividadeLista frmAtividadeLista;

    /**
     * Contrutor da classe
     */
    private FrmAtividadeLista() {
        initComponents();
     ...
     */
    public static FrmAtividadeLista getInstance() {
        if (frmAtividadeLista == null) {
            frmAtividadeLista = new FrmAtividadeLista();
        }

        frmAtividadeLista.setSize(frmAtividadeLista.getPreferredSize());
        frmAtividadeLista.setLocationRelativeTo(null);
        frmAtividadeLista.limparTela();
        return frmAtividadeLista;
    }
    ...
    public void configuraTela() {
        ...
        tblPermissao.setModel(atividadeTableModel);
        atividadeTableModel.configurarTableModel(tblPermissao);
    ...
    public void atualizarTabela() {
        try {
            ...
            if (atividadeTableModel.getRowCount() == 0) {
                JOptionPane.showMessageDialog(null, "Nenhuma atividade encontrada", "Aviso", JOptionPane.INFORMATION_MESSAGE);
            }
        } catch (Exception ex) {
    ...
    /**
     * Método responsável por editar uma atividade da tabela de atividades
     */
    public void editar() {
        ...
        if (!funcionarioController.possuiPermissao("Editar Atividade")) {
            Uteis.mensagemAviso(this, "O usuário não possui a permissão 'Editar Atividade'", "Aviso");
            return;
        }

        funcionarioController.getAtividadeController().frmAtividadeIncAltSetVisible(atividadeTableModel.getAtividade(tblPermissao.getSelectedRow()), true);
    }
    ...
    private void initComponents() {
        ...
        setTitle("PsiqueSis - Atividade - Lista");
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Atividades", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 0, 18))); // NOI18N
    ...
    private void btnRemover1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemover1ActionPerformed
        try {
            ...
            if (!funcionarioController.possuiPermissao("Remover Atividade")) {
                Uteis.mensagemAviso(this, "O usuário não possui a permissão 'Remover Atividade'", "Aviso");
                return;
            }

            if (Uteis.mensagemCondicional(this, "Deseja realmente remover a atividade de ID '" + atividadeTableModel.getValueAt(tblPermissao.getSelectedRow(), "ID") + "'?", "Confirmação") == 1) {
                return;
            }

            Atividade a = atividadeTableModel.getAtividade(tblPermissao.getSelectedRow());
            a.setStatus("Inativo1");
            ...
            funcionarioController.inserirHistorico(new Historico("Removeu a atividade de código '" + a.getId() + "'", new Date(), funcionarioController.getFuncionarioLogado()));
            atualizarTabela();
        } catch (Exception ex) {
